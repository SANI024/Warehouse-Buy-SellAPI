        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SupplierName = table.Column<string>(type: "nvarchar(225)", maxLength: 225, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    WarehouseName = table.Column<string>(type: "nvarchar(225)", maxLength: 225, nullable: false),
                    Address = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InternalMovements_Warehouses_FromWarehouseId",
                        column: x => x.FromWarehouseId,
                        principalTable: "Warehouses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_InternalMovements_Warehouses_ToWarehouseId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InternalMovementItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InternalMovementItems_InternalMovements_MovementId",
                        column: x => x.MovementId,
                        principalTable: "InternalMovements",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_InternalMovementItems_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InternalMovementItems_MovementId",
                table: "InternalMovementItems",
                column: "MovementId");

            migrationBuilder.CreateIndex(
                name: "IX_InternalMovementItems_ProductId",
                table: "InternalMovementItems",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_InternalMovements_FromWarehouseId",
                table: "InternalMovements",
                column: "FromWarehouseId");

            migrationBuilder.CreateIndex(
                name: "IX_InternalMovements_ToWarehouseId",
                table: "InternalMovements",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Suppliers_PersonalNumber",
                table: "Suppliers",
                column: "PersonalNumber",
                unique: true);
